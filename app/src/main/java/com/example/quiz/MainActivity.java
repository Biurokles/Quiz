...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        super.onStart();
        Log.d("Start","No i się zaczęło");
    }

    @Override
    protected void onPause() {
        super.onPause();
        Log.d("Pause","No i się zawiesiło");
    }

    @Override
    protected void onResume() {
        super.onResume();
        Log.d("Resume","No i się ponowniło");
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        Log.d("Destroy","No i się zniszczyło");
    }

    @Override
    protected void onStop() {
        super.onStop();
        Log.d("Stop","No i się zatrzymało");
    }
